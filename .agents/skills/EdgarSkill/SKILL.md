---
name: edgar-skill
description: Pulls 10-K and 10-Q filings from SEC EDGAR for US public companies. Use when researching a ticker, annual or quarterly reports, Item 1A risks, or when the user mentions EDGAR, 10-K, or 10-Q.
---

# EDGAR filings

When researching a US public company, use **SEC EDGAR** (`data.sec.gov`) — not random web pages.
